import { ObjectToTopoResponse, objectToTopoService } from "../../services/model.service";
import InternalServerError from "../../errors/InternalServerError";
import { downloadFileService } from "../../services/files.service";
...
describe('objectToTopoService', () => {
    ...
    it("should call fileDownloadService when staging file", async() => {
        (require('../../services/files.service').downloadFileService as jest.Mock).mockResolvedValue(mockFileData);
